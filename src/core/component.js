...
export default class Component {
   ...
   * UI를 렌더링합니다.
   * @description
   * 초기 마운트 시나 상태 변경 시 _template 메서드로 구성된 UI를 _componentDidMount 메서드를 호출하여 렌더링 합니다.
   * _componentDidMount 메서드 에서의 this._$target = this._template() 실행 코드의 중복을 제거해 줍니다.
   */
  _render() {
